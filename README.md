...
[K 个一组翻转链表](./notes/note-38.md) | k个节点一组将链表进行反转 | 1. 尾插法； 2.递归 | 解决
[两两交换链表中的节点](./notes/note-38.md) | 2个节点一组将链表进行反转 | 1. 尾插法； 2.递归 | 解决
[反转单链表](./notes/note-29.md) | 反转单链表 | 1.尾插法；2.递归| 解决
[反转链表 II](./notes/note-38.md) | 将指定位置的单链表进行反转 | 1.尾插法 | 未解决
